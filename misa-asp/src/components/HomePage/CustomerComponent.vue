<template>
  <div class="customer-component">
    ...
    <div class="testimonial-carousel">
      <button @click="prevTestimonial" class="carousel-button prev-button">
        ‹
      </button>
      ...
      <button @click="nextTestimonial" class="carousel-button next-button">
        ›
      </button>
    </div>
  </div>
  ...
  data() {
    return {
      testimonials: [
        {
          image:
            "https://asp.misa.vn/Content/Images/PNG/Home/Home_New/IMAGE/Customer_rate/9_Luu_Van_Tuan.png",
          ...
          position:
            "Giám đốc Công ty TNHH dịch vụ kế toán thuế và cung cấp lao động Quang Huy",
        },
        {
          image:
            "https://asp.misa.vn/Content/Images/PNG/Home/Home_New/IMAGE/Customer_rate/10_Nguyen_Thi_Thu.png",
        ...
        {
          image:
            "https://asp.misa.vn/Content/Images/PNG/Home/Home_New/IMAGE/Customer_rate/11_Mai_Trong_Hieu.png",
          ...
          position:
            "Chủ tịch hội đồng quản trị Công ty Cổ phần Tư vấn và Đào tạo Kỹ năng kế toán",
        },
        {
          image:
            "https://asp.misa.vn/Content/Images/PNG/Home/Home_New/IMAGE/Customer_rate/12_Nguyen_Thi_Loan.png",
          ...
          position:
            "Giám đóc công ty cổ phần dịch vụ kế toán và đại lý thuế Nam Thái Nguyên",
        },
        {
          image:
            "https://asp.misa.vn/Content/Images/PNG/Home/Home_New/IMAGE/Customer_rate/14_Nguyen_Van_Kha.png",
        ...
        {
          image:
            "https://asp.misa.vn/Content/Images/PNG/Home/Home_New/IMAGE/Customer_rate/15_Dang_Nhat_Minh.png",
          text: "Nhờ có MISA ASP Kế toán sử dụng song song trong quá trình làm việc, tôi dễ dàng phát hiện thao tác nhầm của kế toán dịch vụ. Hay trong trường hợp kế toán chậm trễ, tôi cũng có thể nắm bắt.",
  ...
  methods: {
    ...
    updateCarousel() {
      ...
      container.style.transform = `translateX(-${
        this.currentIndex * testimonialWidth
      }px)`;
    },
  },
  mounted() {
